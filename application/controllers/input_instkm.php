   ...
   public function index()
	...
	public function tambah()
	{
		if ($_POST) {
			...
			$this->data['ddjasid'] = $this->m_database->ddjasidtoday('perkara_id','tanggal_sidang', 'no_perkara', 'perkara_jadwal_sidang');
			$this->data['ddjs'] = $this->m_database->dropdownsipp('id', 'nama_gelar', 'jurusita');
			$this->data['ddhakim'] = $this->m_database->dropdownsipp('id', 'nama_gelar', 'hakim_pn');
