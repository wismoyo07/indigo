...
class Perkarakm extends MY_Controller {
   ...
   public function index()
   {
      ...
      $this->data['konten'] = 'hakim/perkarakm/index';
   ...
   public function get_detail_noputusan(){
        ...
        $this->load->view('hakim/perkarakm/detail', $data);
    }
   ...
   public function cetak()
   {
      ...
      $this->data['query'] = $this->db
                                 ...
                                 ->where('p.id_pendapathukum', $id)
                                 ->get($this->table . ' p')->row_array();
     $this->load->view('hakim/cetak/print_pendapathukum', $this->data);
     // print_r($this->data['query']);
